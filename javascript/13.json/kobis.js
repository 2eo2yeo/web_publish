...
function initForm() {
    const output = `
        ...
        <div id ="search">
            ...
            <input type="text" id="searchDt" placeholder="20241122">
...
function searchBoxOffice(ktype, searchDt) {
   boxOffice(ktype, searchDt)  //promise객체로 리턴
            .then((result)=>{
                // const rankType = ktype.toLowerCase();
                const type = result.boxOfficeResult.boxofficeType;
                const ragnge = result.boxOfficeResult.showRange;
